...
dnf -y install samba-client cifs-utils kernel-modules
...
echo "//server/sambashare /mnt/samba cifs user,rw,credentials=/etc/samba/smbusers,uid=batagiev,gid=sambagroup,_netdev 0 0" >> /etc/fstab
restorecon -vR /etc
#umount /mnt/samba
#mount /mnt/samba
